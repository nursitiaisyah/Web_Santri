    ...
    <section class="pl-2 pt-5 " id="main-content">
      ...
      <div class="col-md-30 p-1 pt-2">
        ...
        <table class="table table-striped table-bordered border-dark shadow h-100">
          ...
          <tbody>
            <div class="tambah">
              <a href="tambah_santri.php" class="btn btn-primary mb-3"><i class="far fa-plus"></i> Tambah</a>
            </div>
            <?php
            include "koneksi.php";
            ...
            while ($data_santri=mysqli_fetch_array($qry_santri)) {
              ...
              <tr>
                ...
                <td><?=$data_santri['tanggal_lahir']?></td>
                ...
                <td><a href="edit_santri.php?id_santri=<?=$data_santri['id_santri']?>"class="btn btn-success"><i class="fal fa-edit fa-sm"></i></a> |
                  <a href="delete.php?id_santri=<?=$data_santri['id_santri']?>"onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">
